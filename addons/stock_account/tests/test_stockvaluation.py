...
class TestStockValuation(TransactionCase):
    ...
    def test_fifo_perpetual_1(self):
        ...
        move1_input_aml = self._get_stock_input_move_lines()
        self.assertEqual(len(move1_input_aml), 1)
        self.assertEqual(move1_input_aml.balance, -100)

        move1_valuation_aml = self._get_stock_valuation_move_lines()
        self.assertEqual(len(move1_valuation_aml), 1)
        self.assertEqual(move1_valuation_aml.balance, 100)

        move1_output_aml = self._get_stock_output_move_lines()
        self.assertEqual(len(move1_output_aml), 0)
        ...
        self.assertEqual(move3.value, 0.0)  # took 3 items from move 1 @ 10.00 per unit
        ...
        # Increase received quantity of move1 from 10 to 12, it should updates the remaining
        # quantity, the value and remaining value on this move without impacting any of the
        # next ones.
        ...
        # Sale 9 units, the units available from the previous increase are sent immediately.
        ...
        self.assertEqual(move4.value, 0.0)  # took 3 items from move 1 @ 10.00 per unit
        ...
        # Sale 20 units, we fall in negative stock for 10 units. Theses are valued at the last
        # FIFO cost and the total is negative.
        ...
        # self.assertEqual(move5.value, -140.0)
        ...
        self.assertEqual(move4.value, 0.0)
        self.assertEqual(move4.remaining_value, 0)

        # Receive 10 units @ 12.00 to counterbalance the negative, we do not do the operation right now.
        ...
        self.assertEqual(move5.price_unit, 0.0)
        self.assertEqual(move5.remaining_qty, -10.0)
        self.assertEqual(move5.value, 0.0)
        self.assertEqual(move5.remaining_value, -80.0)
    ...
    #     self.assertEqual(move1.available_qty, 68.0)
    #
    ...
    #     self.assertEqual(move2.available_qty, 208.0)
    #
    #     self.assertEqual(move1.remaining_qty, 68.0)
    ...
    #     self.assertEqual(move3.available_qty, 114.0)
    #
    #     self.assertEqual(move1.remaining_qty, 0)
    ...
    #     self.assertEqual(move4.available_qty, 154.0)
    #
    #     self.assertEqual(move1.remaining_qty, 0)
    #     self.assertEqual(move2.remaining_qty, 114)
    #     self.assertEqual(move3.remaining_qty, 0.0)  # unused in out moves
    ...
    #     self.assertEqual(move5.available_qty, 232.0)
    #
    #     self.assertEqual(move1.remaining_qty, 0)
    #     self.assertEqual(move2.remaining_qty, 114)
    #     self.assertEqual(move3.remaining_qty, 0.0)  # unused in out moves
    ...
    #     self.assertEqual(move6.available_qty, 116.0)
    #
    #     self.assertEqual(move1.remaining_qty, 0)
    #     self.assertEqual(move2.remaining_qty, 0)
    #     self.assertEqual(move3.remaining_qty, 0.0)  # unused in out moves
    ...
    #     self.assertEqual(move7.available_qty, 54.0)
    #
    #     self.assertEqual(move1.remaining_qty, 0)
    #     self.assertEqual(move2.remaining_qty, 0)
    #     self.assertEqual(move3.remaining_qty, 0.0)  # unused in out moves
    ...
    #     self.assertEqual(move8.available_qty, 0.0)
    #
    #     self.assertEqual(move1.remaining_qty, 0)
    #     self.assertEqual(move2.remaining_qty, 0)
    #     self.assertEqual(move3.remaining_qty, 0.0)  # unused in out moves
    ...
    #     self.assertEqual(move9.available_qty, 44.0)
    #
    #     self.assertEqual(move1.remaining_qty, 0)
    #     self.assertEqual(move2.remaining_qty, 0)
    #     self.assertEqual(move3.remaining_qty, 0.0)  # unused in out moves
    ...
    #     self.assertEqual(move1.available_qty, 60.0)
    #
    #     # Purchase 140 units @ 15.50 per unit
    #     move2 = self.env['stock.move'].create({
    #         'name': '140 units @ 15.50 per unit',
    ...
    #     self.assertEqual(move2.available_qty, 200.0)
    #
    ...
    #     self.assertEqual(move3.available_qty, 10.0)
    #
    ...
    #     self.assertEqual(move4.available_qty, 80.0)
    #
    ...
    #     self.assertEqual(move5.available_qty, 50.0)
    #
