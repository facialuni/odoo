...
class DeliveryCarrier(models.Model):
    ...
    product_type = fields.Selection(related='product_id.type', string='Delivery Product Type', default='service')
    product_sale_ok = fields.Boolean(related='product_id.sale_ok', string='Product Can be Sold', default=False)
