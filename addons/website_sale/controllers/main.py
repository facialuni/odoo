...
class WebsiteSale(http.Controller):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        # if search:
        #     categs = Product.search([('name', 'ilike', search)]).mapped('public_categ_ids')
        #     for categ in categs:
        #         parent_category_ids += categ
        ...
        if search:
            ...
            # if products:
                # for product in products:
                    # if product:
            products_categ = Product.search([('name', 'ilike', search)]).mapped('public_categ_ids')
            parent_categ_search_ids += products_categ
