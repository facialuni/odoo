    ...
    def test_StockLandedCosts(self):
        ...
        for valuation in landed_cost.valuation_adjustment_lines:
            if valuation.cost_line_id.name == 'equal split':
                ...
                self.assertFalse(valuation, 'unrecognized valuation adjustment line')
        ...
        self.assertEqual(len(landed_cost.account_move_id.line_ids), 16, "Wrong move lines in account move.")
