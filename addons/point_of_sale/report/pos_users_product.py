...
class pos_user_product(report_sxw.rml_parse):
    ...
    def _get_data(self, o):
        self.total = 0.0
        sql1=""" SELECT distinct(o.id) from account_bank_statement s, account_bank_statement_line l,pos_order o,pos_order_line i where  i.order_id=o.id and o.state='paid' and l.statement_id=s.id and l.pos_statement_id=o.id and s.id=%s"""
        self.cr.execute(sql1, [o.id])
