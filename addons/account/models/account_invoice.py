    ...
    def action_move_create(self):
        ...
        for inv in self:
            ...
            if inv.payment_term_id:
                totlines = inv.payment_term_id.compute(total, date_invoice)[0]
                res_amount_currency = total_currency
                for i, t in enumerate(totlines):
                    if inv.currency_id != company_currency:
                        amount_currency = company_currency.compute(t[1], inv.currency_id)
                    else:
            ...
            move = account_move.with_context(lang=None).create(move_vals)
