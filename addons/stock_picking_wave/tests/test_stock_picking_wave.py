...
class TestStockPickingWave(TestStockCommon):
    ...
    def test_updateinventory(self):
        ...
        print self.stock_location1
        print "location 1 execution completed"
        ...
        print "location 2 execution completed"
        ...
        print "\n\nLocation 3 execution completed\n\n"
    ...
    def test_outgoingshipment(self):
        ...
        aval_a_qty = self.MoveObj.search([('product_id', '=', self.productA.id), ('picking_id', '=', picking_out.id)], limit=1)

        print 'aval_a_qty', aval_a_qty, '---------', aval_a_qty.reserved_availability
