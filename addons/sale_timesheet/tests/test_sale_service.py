...
class TestSaleService(CommonTest):
    ...
    def test_task_so_line_assignation(self):
        ...
        procurement = task_serv2.procurement_id

        self.assertEqual(task_serv2.procurement_id.group_id, sale_order.procurement_group_id, "Procurement Group should be commun to the generated task and the SO")
        ...
        task_serv2.write({'procurement_id': False})
        ...
        task_serv2.write({'procurement_id': procurement.id})
