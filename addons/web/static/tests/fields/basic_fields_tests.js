...
QUnit.module('basic_fields', {
    ...
    QUnit.test('char field translatable', function (assert) {
        ...
        form.$buttons.find('.o_form_button_edit').click();
        var $button = form.$('input[type="text"].o_form_input.o_form_field + .o_field_translate');
        ...
        $button = form.$('input[type="text"].o_form_input.o_form_field + .o_field_translate');
    ...
    QUnit.test('text field translatable', function (assert) {
        ...
        form.$buttons.find('.o_form_button_edit').click();
        var $button = form.$('div.o_list_text.o_form_field + .o_field_translate');
        assert.strictEqual($button.length, 1, "should have a translate button");
        $button.click();
        form.destroy();
        ...
        $button = form.$('div.o_list_text.o_form_field + .o_field_translate');
        assert.strictEqual($button.length, 0, "should not have a translate button in create mode");
        form.destroy();
