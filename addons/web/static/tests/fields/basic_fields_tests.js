...
QUnit.module('basic_fields', {
    ...
    QUnit.test('phone field in form view on extra small screens for employee', function (assert) {
        assert.expect(7);
    ...
    QUnit.test('phone field in editable list view on extra small screens for employee', function (assert) {
        assert.expect(10);
    ...
    QUnit.test('phone field in form view on normal screens for employee', function (assert) {
        // The behavior of this widget is completely altered by hr_voip so this
        // test is irrelevant and fails if crm_voip is installed. The enterprise
        // module is responsible for testing its own behavior in its own tests.
        if ('hr_voip' in odoo.__DEBUG__.services) {
            assert.expect(0);
            return;
        }
    ...
    QUnit.test('phone field in editable list view on normal screens for employee', function (assert) {
        // The behavior of this widget is completely altered by hr_voip so this
        // test is irrelevant and fails if crm_voip is installed. The enterprise
        // module is responsible for testing its own behavior in its own tests.
        if ('hr_voip' in odoo.__DEBUG__.services) {
    ...
    QUnit.test('phone field does not allow html injections for employee', function (assert) {
        assert.expect(1);
